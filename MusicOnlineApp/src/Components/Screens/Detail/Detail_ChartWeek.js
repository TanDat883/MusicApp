...
export default class DetailChartWeek extends Component {
  render() {
    return (
        <View style={styles.container}>
            <Image style={styles.imgBackGround} source={require('../../../img/detailChartWeek/background.jpg')} />
            <View style={styles.wrapBackGround} />
            <View style={styles.containerTextChart}>
                <View style={styles.wrapTextChart}>
                    <Text style={styles.txtChart}>Tuần 2 - 2018</Text>
                </View>
            </View>
            <View style={styles.header}>
                ...
                <TouchableOpacity style={styles.wrapIconHeader} onPress={() => this.props.navigation.navigate('Screen_Search', { check: true })}>
                    <Image style={styles.iconStyle} source={require('../../../img/icon/searchWhite.png')} />
                </TouchableOpacity>
            </View>
